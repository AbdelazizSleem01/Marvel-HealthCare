...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-50 w-14 h-14 bg-secondary-500 hover:bg-secondary-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 group"
